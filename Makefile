...
test: all
	@assets/filler_vm -f assets/maps/map02 -p2 ./atyrode.filler -p1 assets/players/rbeaufre.filler

test_python: all
	@python3 ../filler_vm_py/filler_vm.py -f assets/maps/map01 -p1 ./atyrode.filler -p2 assets/players/rbeaufre.filler	-q
